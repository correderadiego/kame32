...
void Kame::init(){    
    ...
    servoHandler = new ServoHandler(board_pins);
    home();
}
...
void Kame::hello(){
    ...
    servoHandler->moveServosDelayed(150, sentado);
    delay(200);
    ...
    servoHandler->moveServosDelayed(500, goingUp);
    delay(200);
}
...
void Kame::jump(){
    ...
    servoHandler->moveServosDelayed(150, sentado);
    delay(200);
    servoHandler->moveServosDelayed(0, salto);
    delay(100);
    home();
}
